...
<body style="background-color: #E3E2DE">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="" id="message" class="newmessage btn btn-success pull-right"><i class="fa fa-plus"></i> New Message</a>
                        <div id="popup">   
                        </div>
    ...
    <script type="text/javascript">
                        ...
                        document.getElementByClass("newmessage").addEventListener("click", function(e) {
                            e.preventDefault();
