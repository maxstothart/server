...
<html dir="ltr" lang="en" class=" home_page home_page_design s_layout1 isFreePackage  ">
   <head>
      ...
      <link rel="preload" href="https://static1.s123-cdn-static-a.com/ready_uploads/media/34155/2000_5cde6e763c693.jpg" as="image">
      <!-- Favicon --> 
      <link rel="shortcut icon" href="/logo.png" type="image/x-icon">
      <link rel="icon" href="/logo.png" type="image/x-icon">
      <link rel="manifest" href="https://cdn-cms-s.f-static.net/versions/2/css/manifest.json?w=&orderScreen=&websiteID=5985208&onlyContent=&tranW=&v=css_n152_31566608&wd=620c814d418f3.site123.me">
      <!-- Status Bar -->
      <meta name="apple-mobile-web-app-status-bar-style" content="default">
      <!-- 152px icon -->
      <link rel="apple-touch-icon" sizes="152x152" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=152&height=152&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_n152_31566608">
      <!-- 180px icon -->
      <link rel="apple-touch-icon" sizes="180x180" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=180&height=180&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_n152_31566608">
      <!-- 167px icon -->
      <link rel="apple-touch-icon" sizes="167x167" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=167&height=167&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_n152_31566608">
   ...
   <body id="page-top">
      <div class="body">
               ...
               <div class="site_container">
                  ...
                  <div id="top-menu">
                     <ul class="navPages nav navbar-nav">
                        ...
                        <li class="moduleMenu" data-menu-module-id="620ca974d6c68"><a class="page-unique s123-fast-page-load" href="/store"><span class="txt-container">Store</span></a></li>
                     </ul>
                     <ul class="navActions nav navbar-nav">
                        ...
                        <li class="header-client-zone-wrapper"><a class="client-zone-link" data-close-location="right" href="https://dash.windmill-inc.com" ><i class="svg-m s123-icon-converter " data-icon-name="user" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2');" data-ie11-classes="">&nbsp;</i></a></li>
                        <!-- Menu Action Buttons --> 
                     </ul>
                  </div>
               </div>
         ...
         <nav id="mainNavMobile" class="navbar-fixed-top">
            ...
            <div class="navPagesRight">
               <ul class="navActions nav navbar-nav">
                  ...
                  <li class="header-client-zone-wrapper"><a class="client-zone-link" data-close-location="right" href="/dashboard" ><i class="svg-m s123-icon-converter " data-icon-name="user" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2');" data-ie11-classes="">&nbsp;</i></a></li>
               </ul>
            </div>
         </nav>
         ...
         <div id="s123PjaxMainContainer">
            ...
            <div id="s123ModulesContainer" class="s123-modules-container">
               <section id="section-620c9fcdd6c05" class="s123-module s123-module-pricing-tables layout-1 bg-primary" data-module-id="620c9fcdd6c05" data-module-type-num="10">
                           ...
                           <div class="row modulesTitle text-center">
                              <div class="col-xs-12">
                                 <div class="page-header-wrap">
                                    <H2 id="section-620c9fcdd6c05-title"  class="s123-page-header  ">Pricing</H2>
                                    <input type="email" style="width: 150px;" placeholder="Enter email before you order" name="email" requied="required">
                                    <hr class="small">
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="container" data-aos="fade-up">
                     <div class="row pricing-m ">
                        <div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0">
                           <div class="pricing-m-box  preview-highlighter" data-unique-id="620c9fce8c657">
                              <div class="pricing-m-title">
                                 <h3>Windbook - V2</h3>
                              </div>
                              <div class="pricing-m-price" ><span data-multi-currency-symbol-only="true" class="pricing-m-price-value">&#78;&#90;&#36;</span><span data-multi-currency-price-only="true">700</span></div>
                              <div class="pricing-m-features">
                                 <ul>
                                    <li>Based on Acer Aspire 1</li>
                        ...
                        <div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0">
                           <div class="pricing-m-box pricing-m-popular preview-highlighter" data-unique-id="620c9fce86ece">
                              <div class="pricing-m-title">
                                 <h3>Windbook - V3</h3>
                                 <span>MOST POPULAR</span>
                              </div>
                              <div class="pricing-m-price" style="color:#0b2c4f"><span data-multi-currency-symbol-only="true" class="pricing-m-price-value">&#78;&#90;&#36;</span><span data-multi-currency-price-only="true">900</span></div>
                              <div class="pricing-m-features">
                                 <ul>
                                    <li>Based on Acer Aspire 3</li>
                        ...
                        <div class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0">
                           <div class="pricing-m-box  preview-highlighter" data-unique-id="620c9fce818b5">
                              <div class="pricing-m-title">
                                 <h3>Windbook - V4</h3>
                              </div>
                              <div class="pricing-m-price" ><span data-multi-currency-symbol-only="true" class="pricing-m-price-value">&#78;&#90;&#36;</span><span data-multi-currency-price-only="true">1150</span><span class="pricing-m-price-period">/Month</span></div>
                              <div class="pricing-m-features">
                                 <ul>
                                    <li>based on Dell Inspiron 3000</li>
                                    <li>AMD Ryzen 5 3450U Mobile Processor</li>
                                    <li>8GB RAM</li>
                                    <li>256GB SSD Storage</li>
                                    <li>AMD Radeon Vega 8 Graphics</li>
                                    <li>15.6&quot; 1920 x 1080 display</li>
                                    <li>Runs Windows 11 home</li>
                                 </ul>
                              </div>
                              <div class="pricing-m-action"><button name="Product" type="submit" value="Windbook-V4" class="btn btn-primary btn-block btn-xl" data-module="620c9fcdd6c05" data-unique-page="620c9fce818b5" data-tranw="">Order Now</button></div>
                           </div>
                           </form>
                        </div>
                     </div>
      ...
      <link rel="stylesheet" class="defer-css" data-href="https://cdn-cms-s.f-static.net/versions/2/css/minimize-bottom.css?v=n8158" type="text/css" crossorigin="anonymous">
      <!-- Minimize JS files --> <script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p1.js?v=n8158" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p2.js?v=n8158" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p3.js?v=n8158" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p4.js?v=n8158" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/js.php?v=n8158&umk=10-15" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_scripts.js?v=n8158" crossorigin="anonymous"></script> <!-- Website Statistics --> <script src="https://cdn-cms-s.f-static.net/versions/2/wizard/statistics/js/generateStats-min.js?v=n8158" crossorigin="anonymous"></script> <!-- Floating Magic Button Update Preview Helper -->
      <div>
