...
<html dir="ltr" lang="en" class=" inside_page inside_page_header_design s_layout1 isFreePackage  ">
	<head>
		...
		<!-- Favicon --> 
		<link rel="shortcut icon" href="https://cdn-cms-s.f-static.net/manager/websites/site123_website/files/logos/brand_files_2020/Icons/Png/Icon_blue.png?v=n81967" type="image/x-icon">
		<link rel="icon" href="https://cdn-cms-s.f-static.net/manager/websites/site123_website/files/logos/brand_files_2020/Icons/Png/Icon_blue.png?v=n81967" type="image/x-icon">
		<link rel="manifest" href="https://cdn-cms-s.f-static.net/versions/2/css/manifest.json?w=&orderScreen=&websiteID=5985208&onlyContent=&tranW=&v=css_r153_31566608&wd=620c814d418f3.site123.me&moduleID=">
		<!-- Status Bar -->
		<meta name="apple-mobile-web-app-status-bar-style" content="default">
		<!-- 152px icon -->
		<link rel="apple-touch-icon" sizes="152x152" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=152&height=152&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_r153_31566608&moduleID=">
		<!-- 180px icon -->
		<link rel="apple-touch-icon" sizes="180x180" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=180&height=180&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_r153_31566608&moduleID=">
		<!-- 167px icon -->
		<link rel="apple-touch-icon" sizes="167x167" href="https://cdn-cms-s.f-static.net/ready_uploads/pwaScreenLogo/pwaImage.png?width=167&height=167&resizeType=pwaIcon&w=&orderScreen=&websiteID=5985208&tranW=&v=css_r153_31566608&moduleID=">
	...
	<body id="page-top">
		<div class="body">
			...
			<div id="top-menu-mobile" style="display:none;">
				<ul>
					<!-- Website Menu Pages --> 
					<li class="moduleMenu active"><a class="page-unique homepageMenu" href="/"><span class="txt-container">Home</span></a></li>
			...
			<div id="s123PjaxMainContainer">
				<div class="s123-client-zone-page s123-content-area bg-primary">
								...
								<div class="row modulesTitle text-center">
									<div class="col-xs-12">
										<div class="page-header-wrap">
											<H1 id="section--title"  class="s123-page-header  ">Client Zone</H1>
											<hr class="small">
										</div>
									</div>
								</div>
					...
					<div class="container">
						...
						<div class="row page-loading-icon text-center" style="display: none;"> <i class="svg-m s123-icon-converter fa-spin fa-4x" data-icon-name="spinner" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2');" data-ie11-classes="fa-spin fa-4x">&nbsp;</i> </div>
						<div class="row">
							<div class="col-xs-12 col-sm-4 col-md-3">
								<!-- profile image --> 
								<div class="clientZoneProfileImage" style="display: none;">
									<div class="clientZoneProfileBtn"> <a id="profileBtn" class="btn btn-link"><i class="svg-m s123-icon-converter " data-icon-name="ellipsis-v" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/ellipsis-v.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/ellipsis-v.svg?v=2');" data-ie11-classes="">&nbsp;</i></a> </div>
									<div class="profile-image"> <img id="profileImagePreview" class="img-thumbnail" src="https://cdn-cms-s.f-static.net/versions/2/wizard/clientZone/images/noImage.png" data-src="https://cdn-cms-s.f-static.net/versions/2/wizard/clientZone/images/noImage.png"> </div>
								...
								<div id="clientZone-menu-tabs" class="hidden-xs" style="display: none;">
									<div data-tab="profile" class="col-xs-12 tab active">
										<div class="icon-container"> <i class="svg-m s123-icon-converter " data-icon-name="user" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/user.svg?v=2');" data-ie11-classes="">&nbsp;</i> <span>Profile</span> </div>
									</div>
									<div data-tab="addresses" class="col-xs-12 tab">
										<div class="icon-container"> <i class="svg-m s123-icon-converter " data-icon-name="address-book" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/address-book.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/address-book.svg?v=2');" data-ie11-classes="">&nbsp;</i> <span>My Addresses</span> </div>
									</div>
								</div>
							</div>
										...
										<form id="clientProfile" enctype="multipart/form-data">
											<div class="row">
												<div class="col-xs-12 col-md-5">
													...
													<!-- Phone --> 
													<div class="form-group"> <label for="phone">Phone</label> <input type="text" id="phone" name="phone" class="form-control" placeholder="Phone Number"/> </div>
													<!-- Country --> 
													...
													<!-- Subscribe --> 
													<div class="form-group">
														<label for="unsubscribe">Subscribe</label> <br> <span>Receive our latest news and updates!</span> 
														<div class="checkbox"> <label class="checkbox-label"> <input type="checkbox" id="unsubscribe" name="unsubscribe"> <span class="checkbox-custom"></span> <span class="input-title">Keep me updated</span> </label> </div>
													</div>
													<div class="form-group"> <button type="submit" class="btn btn-primary" style="min-width: 150px;"><span>Save</span><i class="svg-m s123-icon-converter fa-spin" data-icon-name="spinner" style="display: none; mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2');" data-ie11-classes="fa-spin">&nbsp;</i></button> </div>
													<input type="hidden" name="w" value=""> <input type="hidden" name="websiteID" value="5985208"> <input type="hidden" id="profile_image" name="profile_image" value=""> 
												</div>
											</div>
										</form>
									</div>
						...
						<div id="loginFormsContainer" class="row login-forms box box-primary s123-box-top-primary-border" style="display: none;">
							...
							<form id="clientPasswordForm" class="text-center" style="display: none;">
								<p>An email with your personal code has been sent to your mailbox. Please enter the code to login:</p>
								...
								<div class="resend-password-box"> <a id="resendPasswordBtn" style="cursor:pointer">I did not get the email, please send it again.</a> <span id="resendPasswordLoading" style="display:none;"><i class="svg-m s123-icon-converter fa-spin" data-icon-name="spinner" style=" mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2'); -webkit-mask: url('https://static1.s123-cdn-static-a.com/ready_uploads/svg/spinner.svg?v=2');" data-ie11-classes="fa-spin">&nbsp;</i></span> <span id="resendPasswordEmailSent" style="display: none;">The email was sent successfully.</span> </div>
								<input type="hidden" name="w" class="w" value=""> <input type="hidden" name="websiteID" class="websiteID" value="5985208"> <input type="hidden" name="email" class="clientEmail" value=""> 
							</form>
						</div>
					</div>
				</div>
		...
		<link rel="stylesheet" class="defer-css" data-href="https://cdn-cms-s.f-static.net/versions/2/css/minimize-bottom.css?v=n81967" type="text/css" crossorigin="anonymous">
		<!-- Minimize JS files --> <script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p1.js?v=n81967" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p2.js?v=n81967" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p3.js?v=n81967" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_p4.js?v=n81967" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/js.php?v=n81967&umk=10-15" crossorigin="anonymous"></script><script src="https://cdn-cms-s.f-static.net/versions/2/js/minimize_scripts.js?v=n81967" crossorigin="anonymous"></script> <!-- Website Statistics --> <script src="https://cdn-cms-s.f-static.net/versions/2/wizard/statistics/js/generateStats-min.js?v=n81967" crossorigin="anonymous"></script> 
		<link rel="stylesheet" href="https://cdn-cms-s.f-static.net/versions/2/css/client-zone-min.css?v=n81967" type="text/css" crossorigin="anonymous">
		<!-- Google reCaptcha --><script src='https://www.google.com/recaptcha/api.js'></script><!-- Client Zone --><script>/**
		...
		</script> <!-- Floating Magic Button Update Preview Helper -->
		<div>
